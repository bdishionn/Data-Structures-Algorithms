...
public interface SpellChecker {
	...
	/**
	 * Saves the dictionary tree to the specified file in preorder. The file format
	 * is text, with one word per line.
	 * 
	 * @param filename
	 *            Name (possibly including a path) of the file to save to. If the
